...
<div id="slider">
	<span class="inside"><h1>PENGINAPAN</h1>		
		<p>Anda bisa mencari penginapan dimalang dengan website dibawah ini!
	</p></span>
	<figure>
...
<div id="wisata">
	<h1>PENGINAPAN</h1>
	<ul class="tw-box">
		<li class="tw-item"><div class="img-wrap"><img src="img/traveloka.png"></div><p class="alam"><a href="alam.php">traveloka</a></p></li>
		<li class="tw-item"><div class="img-wrap"><img src="img/tiket.png"></div><p class="sejarah"><a href="">tiket</a></p></li>
		<li class="tw-item"><div class="img-wrap"><img src="img/pegi2.png"></div><p class="kuliner"><a href="">pegi pegi</a></p></li>
	</ul>
</div>
