...
<div id="wisata">
	<h1>wisata</h1>
	<ul class="tw-box">
		<li class="tw-item"><div class="img-wrap"><img src="img/Gunung-Bromo.jpg"></div><p class="alam"><a href="alam.php">wisata alam</a></p></li>
		<li class="tw-item"><div class="img-wrap"><img src="img/jatim2.jpg"></div><p class="buatan"><a href="">wisata buatan</a></p></li>
		<li class="tw-item"><div class="img-wrap"><img src="img/ckidal.jpg"></div><p class="sejarah"><a href="">wisata sejarah</a></p></li>
		<li class="tw-item"><div class="img-wrap"><img src="img/miiblis.jpg"></div><p class="kuliner"><a href="">wisata kuliner</a></p></li>
	</ul>
</div>
...
<div id="fasilitas">
	<h1>fasilitas</h1>
	<ul class="tf-box">
		<li class="tf-item tf-img1"><div class="tf-info"><h3><a href="">restauran</a></h3></div></li>
		<li class="tf-item tf-img2"><div class="tf-info"><h3><a href="">transportasi</a></h3></div></li>
		<li class="tf-item tf-img3"><div class="tf-info"><h3><a href="">pembimbing tour</a></h3></div></li>
		<li class="tf-item tf-img4"><div class="tf-info"><h3><a href="hotel.php">penginapan</a></h3></div></li>
		<li class="tf-item tf-img5"><div class="tf-info"><h3><a href="">penukaran uang</a></h3></div></li>
	</ul>
</div>
